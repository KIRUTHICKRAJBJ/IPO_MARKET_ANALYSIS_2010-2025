...
Identify top-performing IPOs by size and listing gain.

Analyze investor demand segmentation (QIB, HNI, RII).
...
Analysis: Performed EDA, trend and correlation analyses.

Visualization: Built dashboards/charts for easier insight discovery.
...
Top IPOs by Issue Size: Hyundai Motor India, LIC India, One97 Communications

Top Listing Gains: Coal India Ltd, HDB Financial Services, Vodafone Idea Ltd

Investor Demand Averages: QIB (47.31), HNI (74.42), RII (15.92)
...
Investor segmentation & demand analysis

IPO leaderboard creation

Correlation and insight visualization
...
Expand dashboard scope to cover post-listing performance
